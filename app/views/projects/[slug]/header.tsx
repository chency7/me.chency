...
export const Header: React.FC<Props> = ({ project, views }) => {
  ...
  return (
    <header
      ref={ref}
      className="isolate overflow-hidden relative bg-gradient-to-tl from-black to-black via-zinc-900"
    >
      <div
      ...
      <div className="container isolate overflow-hidden relative py-24 mx-auto sm:py-32">
        <div className="flex flex-col items-center px-6 mx-auto max-w-7xl text-center lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h1 className="text-4xl font-bold tracking-tight text-white font-display sm:text-6xl">
              {project.title}
            </h1>
